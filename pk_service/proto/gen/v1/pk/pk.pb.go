...
type JoinResponse struct {
	...
	Answer   int32    `protobuf:"varint,3,opt,name=answer,proto3" json:"answer,omitempty"`    // 答案
}
...
func (x *JoinResponse) GetAnswer() int32 {
	if x != nil {
		return x.Answer
	}
	return 0
...
var file_pk_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x22, 0x20, 0x0a,
