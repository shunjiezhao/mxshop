...
type OrderClient interface {
	...
	CreateCart(ctx context.Context, in *CartItemRequest, opts ...grpc.CallOption) (*ShopCartInfoResponse, error)
	...
	OrderList(ctx context.Context, in *OrderFilterRequest, opts ...grpc.CallOption) (*OrderFilterResponse, error)
...
func (c *orderClient) CreateCart(ctx context.Context, in *CartItemRequest, opts ...grpc.CallOption) (*ShopCartInfoResponse, error) {
...
func (c *orderClient) OrderList(ctx context.Context, in *OrderFilterRequest, opts ...grpc.CallOption) (*OrderFilterResponse, error) {
	out := new(OrderFilterResponse)
...
func (c *orderClient) PayOrder(ctx context.Context, in *PayOrderRequest, opts ...grpc.CallOption) (*PayOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Order/PayOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	CreateCart(context.Context, *CartItemRequest) (*ShopCartInfoResponse, error)
	...
	OrderList(context.Context, *OrderFilterRequest) (*OrderFilterResponse, error)
...
func (UnimplementedOrderServer) CreateCart(context.Context, *CartItemRequest) (*ShopCartInfoResponse, error) {
...
func (UnimplementedOrderServer) OrderList(context.Context, *OrderFilterRequest) (*OrderFilterResponse, error) {
